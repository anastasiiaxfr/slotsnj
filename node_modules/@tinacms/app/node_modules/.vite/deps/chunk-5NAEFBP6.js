...
// node_modules/@tinacms/sharedctx/dist/index.es.js
...
var EditProvider = ({
  ...
  const [edit, setEditState] = (0, import_react.useState)(isEditing());
  const [formsRegistering, setFormsRegistering] = (0, import_react.useState)(false);
  const setEdit = (edit2) => {
    setEditState(edit2);
    setEditing(edit2);
  };
  return import_react.default.createElement(EditContext.Provider, {
...
//# sourceMappingURL=chunk-5NAEFBP6.js.map
