...
import {
  ...
  clsx,
  hideOthers
} from "./chunk-QB5TPLND.js";
import {
  _extends
} from "./chunk-SJ46GW5Y.js";
import {
  require_jsx_runtime
} from "./chunk-JIPH3X4O.js";
import {
  require_react_dom
} from "./chunk-KXUS23VM.js";
import {
  HistoryStore,
  StorageAPI,
...
async function Se5(e6, t15) {
  const n7 = await import("./codemirror.es-F4CJPDIG.js").then((r10) => r10.c).then(
    (r10) => (
  ...
  return await Promise.all(
    (t15 == null ? void 0 : t15.useCommonAddons) === false ? e6 : [
      import("./show-hint.es-7KPUDDPR.js").then((r10) => r10.s),
      import("./matchbrackets.es-LOFYGU3P.js").then((r10) => r10.m),
      import("./closebrackets.es-NVMYOTXU.js").then((r10) => r10.c),
      import("./brace-fold.es-LM4DNTJW.js").then((r10) => r10.b),
      import("./foldgutter.es-CCZUSBFT.js").then((r10) => r10.f),
      import("./lint.es-7WD7TRKG.js").then((r10) => r10.l),
      import("./searchcursor.es-EZHOO5BD.js").then((r10) => r10.s),
      import("./jump-to-line.es-EIB5XJP5.js").then((r10) => r10.j),
      import("./dialog.es-KFQKJLPK.js").then((r10) => r10.d),
      // @ts-expect-error
      import("./sublime.es-ZMRS4MPJ.js").then((r10) => r10.s),
      ...e6
    ]
  ), n7;
}
...
function Ce4({
  ...
  return (0, import_react97.useEffect)(() => {
    ...
    return Se5([
      // @ts-expect-error
      import("./javascript.es-ZYCSYG3B.js").then((C5) => C5.j)
    ]).then((C5) => {
      if (!g5)
        return;
...
function se5({
  ...
  (0, import_react97.useEffect)(() => {
    ...
    let A4 = true;
    return Se5([
      import("./comment.es-ZS66DKKE.js").then((k2) => k2.c),
      import("./search.es-4CJPWU4R.js").then((k2) => k2.s),
      import("./hint.es-Q4ILCOAM.js"),
      import("./lint.es2-ODTPU4RL.js"),
      import("./info.es-ZLUNAEY3.js"),
      import("./jump.es-XOGGS5Q4.js"),
      import("./mode.es-WNJHVCZX.js")
    ]).then((k2) => {
      if (!A4)
        return;
      D7.current = k2;
...
function me4({
  ...
  return (0, import_react97.useEffect)(() => {
    let C5 = true;
    return Se5([
      import("./hint.es2-BQ7A6GOK.js"),
      import("./lint.es3-KKMG7FXU.js"),
      import("./mode.es2-KX63UQ5I.js")
    ]).then((d14) => {
      if (!C5)
        return;
      g5.current = d14;
...
function it3({
  ...
  return (0, import_react97.useEffect)(() => {
    ...
    return Se5(
      [
        import("./foldgutter.es-CCZUSBFT.js").then((u10) => u10.f),
        import("./brace-fold.es-LM4DNTJW.js").then((u10) => u10.b),
        import("./dialog.es-KFQKJLPK.js").then((u10) => u10.d),
        import("./search.es-4CJPWU4R.js").then((u10) => u10.s),
        import("./searchcursor.es-EZHOO5BD.js").then((u10) => u10.s),
        import("./jump-to-line.es-EIB5XJP5.js").then((u10) => u10.j),
        // @ts-expect-error
        import("./sublime.es-ZMRS4MPJ.js").then((u10) => u10.s),
        import("./mode.es3-YUH4FOYY.js"),
        import("./info-addon.es-R5FKKIKD.js")
      ],
